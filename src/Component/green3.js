...
export default function Green3() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.green.color_green_3);
      let list = result.data.items.green.color_green_3
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.green ? color.green.color_green_3.map((item) => (
