...
export default function Blue9() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.blue.color_blue_9);
      let list = result.data.items.blue.color_blue_9
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.blue ? color.blue.color_blue_9.map((item) => (
