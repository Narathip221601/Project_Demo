...
export default function Blue10() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.blue.color_blue_10);
      let list = result.data.items.blue.color_blue_10
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.blue ? color.blue.color_blue_10.map((item) => (
