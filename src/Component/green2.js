...
export default function Green2() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.green.color_green_2);
      let list = result.data.items.green.color_green_2
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.green ? color.green.color_green_2.map((item) => (
