...
export default function Green6() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.green.color_green_6);
      let list = result.data.items.green.color_green_6
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.green ? color.green.color_green_6.map((item) => (
