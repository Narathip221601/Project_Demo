...
export default function Red4() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.red.color_red_4);
      let list = result.data.items.red.color_red_4
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.red ? color.red.color_red_4.map((item) => (
