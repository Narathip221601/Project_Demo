...
export default function Green9() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.green.color_green_9);
      let list = result.data.items.green.color_green_9
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.green ? color.green.color_green_9.map((item) => (
