...
export default function Blue6() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.blue.color_blue_6);
      let list = result.data.items.blue.color_blue_6
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.blue ? color.blue.color_blue_6.map((item) => (
