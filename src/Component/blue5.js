...
export default function Blue5() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.blue.color_blue_5);
      let list = result.data.items.blue.color_blue_5
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.blue ? color.blue.color_blue_5.map((item) => (
