...
export default function Blue7() {
  ...
  useEffect(() => {
    ...
    Axios({
      ...
      console.log("result", result.data.items.blue.color_blue_7);
      let list = result.data.items.blue.color_blue_7
  ...
  return (
    ...
    <div>
      ...
      <Row className="bout2">
        ...
        {
          color.blue ? color.blue.color_blue_7.map((item) => (
